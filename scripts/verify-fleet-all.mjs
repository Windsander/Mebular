...
const SUITES = [
  ...
  { name: 'quickstart', script: fileURLToPath(new URL('./verify-fleet-quickstart.mjs', import.meta.url)) },
  { name: 'tasks', script: fileURLToPath(new URL('./verify-fleet-tasks.mjs', import.meta.url)) },
