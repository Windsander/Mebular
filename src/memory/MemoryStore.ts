...
export class MemoryStore {
  ...
  async addEntity(input: EntityInput): Promise<EntityNode> {
    ...
    return this.asTyped<EntityNode>(await this.graph.getNode(node.id));
  }
  ...
  async addFact(input: FactInput): Promise<FactNode> {
    ...
    return this.asTyped<FactNode>(await this.graph.getNode(node.id));
  }
  ...
  async addEpisode(input: EpisodeInput): Promise<EpisodeNode> {
    ...
    return this.asTyped<EpisodeNode>(await this.graph.getNode(node.id));
  }
  ...
  async addSkill(input: SkillInput): Promise<SkillNode> {
    ...
    return this.asTyped<SkillNode>(await this.graph.getNode(node.id));
  }
  ...
  async addMeta(input: MetaInput): Promise<MetaNode> {
    ...
    return this.asTyped<MetaNode>(await this.graph.getNode(node.id));
  }
  ...
  private asTyped<T extends Node>(node: Node | null): T {
    if (!node) {
